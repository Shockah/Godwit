...
public class SingleAsset<T> extends Asset<T> {
	@Getter(lazy = true)
	...
	public SingleAsset(@Nonnull String fileName, @Nonnull Class<T> clazz, @Nullable AssetLoaderParameters<T> parameters) {
